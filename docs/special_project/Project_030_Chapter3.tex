...
\hspace*{1.3em} %ย่อหน้า
\textbf{กระบวนการ 1.0 การยืนยันตัวตนและกำหนดสิทธิ์ผู้ใช้} (ภาพที่ \ref{fig3:data_flow_level_1_auth}) ทำหน้าที่เป็น \textit{gatekeeper} ของ API ทั้งระบบ โดยรับข้อมูลยืนยันตัวตนจากผู้ใช้ผ่าน Midori และ/หรือบริการยืนยันตัวตน จากนั้นสร้าง/ตรวจสอบ Session และผูกกับข้อมูลผู้ใช้ในฐานข้อมูลเพื่อกำหนดบทบาท (ADMIN/INSTRUCTOR/STUDENT) ผลลัพธ์คือ token/session ที่ใช้ซ้ำได้ในการเรียก API อื่น ๆ และข้อมูลสิทธิ์ที่ใช้ประกอบการอนุมัติการเข้าถึงทรัพยากร
